...
class SchemaEngine(SQLDatabase):
    def __init__(self, engine: Engine, schema: Optional[str] = None, metadata: Optional[MetaData] = None,
                 ...
                 sample_rows_in_table_info: int = 1000, indexes_in_table_info: bool = False,
    ...
    def fectch_distinct_values(self, table_name: str, column_name: str, max_num: int = 1000):
    ...
    def init_mschema(self):
        for table_name in self._usable_tables:
            ...
            for field in fields:
                ...
                try:
                    examples = self.fectch_distinct_values(table_name, field_name, 1000)
                except:
                    examples = []
